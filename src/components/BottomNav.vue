  ...
  >
    <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
      <nav class="flex items-center justify-between flex-wrap bg-teal">
        <div :class="open ? 'block' : 'hidden'" class="w-full items-center">
          <div class="text-xs mt-1 mr-12 text-subtitle-grey">
            <span class="px-1" />
            <button
              class="
                block
          ...
          <div class="py-4">
            <button
              ...
              "
            >
              <span class="px-3 text-xs lg:text-sm">Masuk</span>
            </button>
            <span class="px-1" />
            <button
              type="button"
              ...
              "
            >
              <span class="inline-flex text-xs lg:text-sm">
                Daftar Sekarang
              </span>
            </button>
          </div>
        ...
        <div class="block sm:hidden">
          ...
          >
            ...
            <span class="tab tab-home block text-xs">Promotions</span>
          </button>
        </div>
        <div class="block sm:hidden">
          <button
          ...
          >
            ...
            <span class="tab tab-home block text-xs">Others</span>
          </button>
        </div>
      </nav>
    </div>
